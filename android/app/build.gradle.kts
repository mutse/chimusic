...
android {
    namespace = "com.example.chimusic"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.chimusic"
    ...
    buildTypes {
        release {
            // Use CI/CD release signing when available, otherwise fall back so
            // unsigned repositories can still produce installable artifacts.
            signingConfig =
                if (hasReleaseSigning) {
